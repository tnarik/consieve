...
if (require.main === module) {
   ...
   fetchFromTitle("ICF", "Location", "confluence.sp.vodafone.com");
   // fetchFromTitle("ICF", "Trackimo Event Adapter", "confluence.sp.vodafone.com");
   /*
   fetchFromTitle("~eduardo.gomezmelguizo@vodafone.com", "Trackimo Event Adapter",
    "confluence.sp.vodafone.com");
   */
} else {
